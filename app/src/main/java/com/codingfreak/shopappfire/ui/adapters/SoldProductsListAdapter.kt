...
import com.codingfreak.shopappfire.ui.activities.SoldProductDetailsActivity
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (holder is MyViewHolder) {
            ...
            holder.itemView.setOnClickListener {
                val soldProductDetailsIntent =
                    Intent(context, SoldProductDetailsActivity::class.java)
                soldProductDetailsIntent.putExtra(Constants.EXTRA_SOLD_PRODUCT_DETAILS , model)
                context.startActivity(soldProductDetailsIntent)
            }
        }
    }
